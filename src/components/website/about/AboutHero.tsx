...
const AboutHero = () => {
  return (
    <section id="home" className="relative min-h-[85vh] md:min-h-[80vh] w-full">
      {/* Background Image */}
      <div
      ...
      {/* Content */}
      <div className="relative z-10 flex min-h-[85vh] md:min-h-[90vh] lg:min-h-[80vh] items-center justify-center text-center">
        <div className="mx-auto container px-4 sm:px-6">
          <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center my-10 md:my-15">
              <Image
                className="rounded-full object-cover w-36 h-36 sm:w-44 sm:h-44 md:w-50 md:h-50"
